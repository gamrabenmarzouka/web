...
"><i class="fa fa-circle-o"></i> Gestion des consultations </a></li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <!-- Info boxes -->
                <script src="js/article/check_form.js"></script>
                <?php
                ...
                <form method="post" enctype="multipart/form-data" name="f" id="f" action="update_data.php" onsubmit="return verif()">
                    <div class="form-group">
                        ...
                        <input type="text" name="nom" id="nom" class="form-control" value="<?= $article['name'] ?>">
                    </div>
                    <div class="form-group">
                        <img src="../../uploads/<?= $article["image_file"] ?>" width="256" alt="<?= $article["image_file"] ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="date_creation" id="datetime-local" class="form-control" value="<?= str_replace(" ", "T", substr($article['created_at'], 0, 16)) ?>">
                    </div>
                    <div class="form-group">
