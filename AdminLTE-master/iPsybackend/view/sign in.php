...
if ($message!='pseudo ou mot de passe incorrect'&& $message==='admin'){
    $_SESSION['m_un']=$_POST["email"];
header('Location:accueil.php');}
else if($message!='pseudo ou mot de passe incorrect'&& $message!='admin'){
    $_SESSION['m_un']=$_POST["email"];
header('Location:../../../iPsy/view/index.php');}
else{
