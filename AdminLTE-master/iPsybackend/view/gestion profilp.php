...
foreach($liste as $patient) {
 ?>                         
                            <tr>
                            <td>
                                     <div class="name" > <?PHP echo $patient['nom']; ?></div>   
                            </td>
                            <td>
                                      <div class="name" > <?PHP echo $patient['prenom']; ?></div>     
                            </td>
                            <td>
                                    <div class="name" ><?PHP echo $patient['email']; ?></div>  
                            </td>
                            <td>
                            <div class="name" ><?PHP echo $patient['mdp']; ?></div>
                            </td>
                            <td>
                            <div class="name" ><?PHP echo $patient['averti']; ?></div>
                            </td>
