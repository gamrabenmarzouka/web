...
<!--<link rel="stylesheet" href="../assets/css/styles/test.css">
	<script src="https://kit.fontawesome.com/b99e675b6e.js"></script>-->
                  ...
                  <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php  echo $_SESSION['nom']; ?><span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                      <li><a href="gestion profilp.php">gestion de profil</a></li>
