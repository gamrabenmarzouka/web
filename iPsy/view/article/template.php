...
"><i class="fa fa-circle-o"></i> Gestion des consultations </a></li>
                            ...
                            <li><a href="index.php?module=article&op=research">Liste des articles</a></li>
                            <li><a href="index.php?module=categorie&op=research">Liste des catégories</a></li>
                        </ul>
                    </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                ?>
                <h1>Ajout Article </h1>
                <form method="post" enctype="multipart/form-data" name="f" id="f" action="create_data.php" onsubmit="return verif()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image_file" width="256" id="image_file" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="date_creation" id="datetime-local" class="form-control" value="<?= str_replace(" ", "T", date("Y-m-d H:i")) ?>">
                    </div>
                    <div class="form-group">
                        <label for="categorie">categorie</label>
                        <select name="categorie[]" id="categorie" class="form-control" size="8" multiple>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="op" value="create_data">
                    </div>
                </form>
            </section><!-- /.content -->
        </div><!-- /.content-wrapper -->
