...
<body class="skin-blue">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            ../../model/ href="index2.html" class="logo"><b>E-PSY</b></a>
...
"><i class="fa fa-circle-o"></i> Gestion des consultations </a></li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="my-4">
                    <a class="btn btn-success" href="create.php">Nouvel Article</a>
                </div>

                <?php
                if ($search_word != "") {
                    $articles = CrudArticle::searchByName($conn, $search_word);
                    echo "<p>Résultat du recherche par &quot;$search_word&quot;</p>";
                } else {
                    echo "<p>Tous les articles disponibles.</p>";
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            foreach ($articles as $row) :
                                $categories = CrudCatgeories::fetchByArticleId($conn, $row["id"]);
                            ?>
                                <tr>
                                    <td><?= $row['id'] ?></td>
                                    <td><?= $row['name'] ?></td>
                                    <td><?= $row['slug'] ?></td>
                                    <td><?= htmlentities(strlen($row['content']) > 100 ? substr($row['content'], 0, 100) : $row["content"]) ?></td>
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td>
                                        <a href="preview.php?article_id=<?= $row["id"] ?>"><img src="../../assets/img/preview-button.png" alt="Afficher"></a>
                                        <?php if ($user['type'] == 'psy') : ?>
                                            <a href="update.php?article_id=<?= $row["id"] ?>"><img src="../../assets/img/edit-button.png" alt="Mise à jour"></a>
                                            <a href="delete.php?article_id=<?= $row["id"] ?>"><img src="../../assets/img/trash-button.png" alt="Suppression"></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                        <?php
